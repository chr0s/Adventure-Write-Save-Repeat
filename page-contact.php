...
*/
 ...
 get_header(); ?>
    ...
    <div class="container" id="awsr-content">
		...
		If you're looking for a <strong>good</strong> and <strong>reliable</strong> <a href="<?php echo home_url('/a-writer'); ?>">freelance writer</a> or <a href="<?php echo home_url('/a-web-designer'); ?>">web designer</a></strong>, get in touch.<p>
